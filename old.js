...
function startQuiz(){
    ...
    for (var i = 0; i < questionArray.length; i++){
        ...
        a1.addEventListener('click',oneCorrect);
        a2.addEventListener('click',twoCorrect);
        a3.addEventListener('click',threeCorrect);
        a4.addEventListener('click',fourCorrect);
